const MenuItems = [{
  ...
  'blocks': 
    [{
      ...
      'description': 'Our steaks are British farm assured highest quality and dry aged for a minimum of 28 days',
      'items': [
        {
        'Steaks':
          [{
        ...
        'Specials':
          [{
            'title': 'Venison Steak',
            'description': 'with dauphinoise potato, carrot & swede purée buttered asparagus and cherry & blackberry sauce',
            'price': '17.95 / 14.95'
          },{
            'title': 'Hangar Steak',
            'description': 'with onion bacon mash, spinach, carrot fondant and a mushroom truffle sauce',
            'price': '17.95 / 14.95'
          },{
            'title': '40oz T-Bone Steak for Two',
            'description': 'with salt and vinegar roast potatoes,béarnaise & red wine sauce and a house salad',
            'price': '17.95 / 14.95'
          }]
        },
        {
        'Add To Your Steak':
          ...
          [{
            ...
            'description': 'with spinach, pickled vegetables and lobster sauce',
            'price': '13.95'
          }]                
        }, {
          'Skewer Boards':
          [{
            ...
            'description': 'brushed with a lime butter and served with fries and paprika mayonnaise',
            'price': '14.95'
          },{
            'title': 'Pesto Halloumi',
            'description': 'with peppers, courgettes, aubergines and red onions served with salsa potatoes',
            'price': '11.95',
            'tags': ['vegetarian']
          },{
            'title': 'Argentinian Style Beef Skewer',
            'description': 'marinated in chimichurri sauce and served with salsa potatoes and garlic dip',
            'price': '14.95'
          },{
            'title': 'King Prawn, Hake & Chorizo',
            'description': 'with peppers & onions and served with fries and paprika mayonnaise',
            'price': '15.45'
          }]                
        }
      ]
      ...
      'items': [
        ...
        'Vegetarian':
          [{
            ...
            'title': 'Mango, Green Pepper and Chilli Risotto Balls with Basil Pesto',
            'price': '5.95',
            'tags': ['vegetarian']
          },{
