...
class GalleryAddItem extends Component {
  ...
  submitPhoto(e) {
    ...
    const tagNodes = e.target.querySelectorAll('.GalleryAddItem__modal--form--tags--checkbox')
    let tags = []
  ...
  resetTags = () => {    
    const tagNodes = document.querySelectorAll('.GalleryAddItem__modal--form--tags--checkbox')
    tagNodes.forEach(tag => {
      ...
      <div className="GalleryAddItem" onClick={ (e) => { if (e.target === this._vNode.dom) { addItem(null) }}}>
        ...
        <div className="GalleryAddItem__modal">
          <form className="GalleryAddItem__modal--form" onSubmit={ (e) => this.submitPhoto(e) }>
            ...
            <label>Tags</label>
            <div className="GalleryAddItem__modal--form--tags">
              { Tags }
            </div>
