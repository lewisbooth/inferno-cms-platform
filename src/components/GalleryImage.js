  ...
  render() {
    ...
    return (
      <div className="Gallery__items--block">
        <img
          className="Gallery__items--block--image"
        ...
        {editMode ? (
          <div className="Gallery__items--block--icons">
            <div className="Gallery__items--block--icons--container">
              <button
                onClick={() => deleteItemModal(imageIndex)}
                className="Gallery__items--block--icons--container--remove-item"
              >
                ✕
              </button>
            ...
            <div className="Gallery__items--block--icons--container">
              <button
                onClick={() => editItem(imageIndex)}
                className="Gallery__items--block--icons--container--edit-item"
              >
                <img
                  alt="Edit Item"
